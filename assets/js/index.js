...
const bg_music = new Audio("assets/musics/music.mp3");
const lose_music = new Audio("assets/musics/lose.mp3");
const gain_music = new Audio("assets/musics/gain.mp3");
const gameover_music = new Audio("assets/musics/gameover.mp3");
